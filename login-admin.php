    ...
    <div class="login-box">
      <div class="card ">
        <div class="card-body login-card-body"><img src="./public/images/bhaLogo.png" style="width:150px;height:150px; object-fit:cover">
          <p class="login-box-msg" style="color:gray">Sign in as Admin</p>
          <form action="loginprocess.php" method="post">
            ...
            <div class="input-group mb-3">
              ...
              <div class="input-group-append">
                ...
                <input name="role" id="role" type="hidden"  value="Admin" />
                ...
                <div style="display:flex; flex-direction: column; font-size:0.9em; margin-bottom:20px; gap:10px;">
                  ...
                  <a href="login-doctor.php" style="color:black; text-decoration:underline;">Login as doctor? Click here</a>
                </div>
