! function(t, e) {
    ...
    var Qe, $e = function(t) {
        ...
        Je = Object.freeze({
            ...
            update: function(e) {
                ...
                var o = {};
                Object.keys(e).forEach(function(t) {
                    Ge.isUpdatableParameter(t) ? o[t] = e[t] : D('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here:'))
                });
                var i = c({}, n, o);
    ...
    function Xe() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && v("This package requires a Promise library, please include a shim to enable it in this browser (See:)"), Qe = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
