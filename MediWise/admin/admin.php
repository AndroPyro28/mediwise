        ...
        <div class="card-header border-1">
            <div class="d-flex flex-row justify-content-end">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo ' <td><a name="view" value="Update" id="' . $row["admin_id"] . '" class="btn btn-success btn-block update_account" style="color:white;"><i class="fas fa-edit" style="color:white;"></i></a></td>';
                }
                ?>
</form>
<?php
