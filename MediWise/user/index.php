...
<body id="main_body" class="hold-transition sidebar-mini " onload="load_dashboard()">
<div class="wrapper">
  <!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- brand logo -->
      <a href="#" onclick="load_dashboard()" class="brand-link">
    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../Prescription.php" onclick="load_appointment()" class="nav-link">
