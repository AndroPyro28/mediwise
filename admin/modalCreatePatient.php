  ...
  <div class="row">
    <div class="col-sm-12 col-12"> 
      <div class="form_group">
        ...
        <input class="form-control" type="text" name="username" id="username" value="" maxlength="50"  required/>
      </div>
    </div> 
  </div> 
  ...
  <div class="row">
    <div class="col-sm-12 col-12"> 
      <div class="form_group">
        ...
        <input class="form-control" type="date" name="birthdate" id="birthdate"  value="" maxlength="250"  required/>
      </div>
    </div> 
  </div> 
  ...
  <div class="row">
    <div class="col-sm-12 col-12"> 
      <div class="form_group">
        ...
        <input class="form-control" type="text" name="contact_number" id="contact_number" value="" maxlength="11"  required/>
      </div>
    </div> 
  </div> 
  ...
  <div class="row">
    <div class="col-sm-12 col-12"> 
      <div class="form_group">
        ...
        <input class="form-control" type="email" name="email" id="email" value="" maxlength="50"  required/>
      </div>
    </div> 
  </div> 
